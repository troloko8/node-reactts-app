...
var showAlert = exports.showAlert = function showAlert(type, message) {
  var ms = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 5000;
  hideAlert();
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if ((res === null || res === void 0 || (_res$data = res.data) === null || _res$data === void 0 ? void 0 : _res$data.status) == "succes") {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Erorr logging out, pls try again');
        case 10:
        case "end":
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe'; // ? 'http://localhost:3000/api/v1/users/updateMyPassword'
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51PVIZCKhxG4HBFylN3uBjwRsMYD8Igen9oFqYd4iAs6rGheIzUNT7Dkx1gPgI41ZYoLMftODGYkOeqlr42GBfJIP004uWIvTmi');
          _context.prev = 1;
          _context.next = 4;
...
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js"}],"../../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var curPassword = document.getElementById('password-current').value;
    var password = document.getElementById('password').value;
